...
namespace E_space
{
    public partial class Form22 : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("DELETE fROM Colonist_Qualification where Qualification like '" + textBox4.Text + "'", con);
                con.Open();
                cmd.ExecuteNonQuery();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("UPDATE Colonist_Qualification SET Mars_Colonization_ID='" + guna2ComboBox1.Text + "' WHERE  Qualification='" + textBox1.Text + "' ", con);
                cmd.ExecuteNonQuery();
        ...
        {
            if (guna2ComboBox1.Text == "" || textBox1.Text == "")
            {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("INSERT INTO Colonist_Qualification (Mars_Colonization_ID, Qualification) VALUES(' " + guna2ComboBox1.Text + " ' , ' " + textBox1.Text + " ' ) ", con);
                cmd.ExecuteNonQuery();
        ...
        {
            // TODO: This line of code loads data into the 'e_SpaceDataSet78.Colonist' table. You can move, or remove it, as needed.
            this.colonistTableAdapter1.Fill(this.e_SpaceDataSet78.Colonist);
            // TODO: This line of code loads data into the 'e_SpaceDataSet77.Colonist_Qualification' table. You can move, or remove it, as needed.
            this.colonist_QualificationTableAdapter.Fill(this.e_SpaceDataSet77.Colonist_Qualification);
