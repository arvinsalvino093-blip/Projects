...
namespace E_space
{
    public partial class Form23 : Form
    {
        ...
        {
            if (guna2ComboBox1.Text == "" || textBox2.Text == "")
            {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("INSERT INTO Astronomer_Qualification (Astronomer_ID, Qualification) VALUES(' " + guna2ComboBox1.Text + " ' , ' " + textBox2.Text + " ' ) ", con);
                cmd.ExecuteNonQuery();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("UPDATE Astronomer_Qualification SET Astronomer_ID='" + guna2ComboBox1.Text + "' WHERE Qualification='" + textBox2.Text + "' ", con);
                cmd.ExecuteNonQuery();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("DELETE fROM Astronomer_Qualification where Astronomer_ID like '" + textBox4.Text + "'", con);
                con.Open();
                cmd.ExecuteNonQuery();
        ...
        private void button4_Click(object sender, EventArgs e)
        {
           ...
           // if (sdr.Read())
            while (sdr.Read())
            {
                guna2ComboBox1.Text = sdr["Astronomer_ID"].ToString();
        ...
        {
            // TODO: This line of code loads data into the 'e_SpaceDataSet93.Astronomer_Qualification' table. You can move, or remove it, as needed.
            this.astronomer_QualificationTableAdapter.Fill(this.e_SpaceDataSet93.Astronomer_Qualification);
            // TODO: This line of code loads data into the 'e_SpaceDataSet92.Astronomer' table. You can move, or remove it, as needed.
            this.astronomerTableAdapter.Fill(this.e_SpaceDataSet92.Astronomer);
