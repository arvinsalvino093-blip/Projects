...
namespace E_space
{
    public partial class Form9 : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'e_SpaceDataSet88.Pilot' table. You can move, or remove it, as needed.
            this.pilotTableAdapter.Fill(this.e_SpaceDataSet88.Pilot);
            // TODO: This line of code loads data into the 'e_SpaceDataSet87.Astronomer' table. You can move, or remove it, as needed.
            this.astronomerTableAdapter4.Fill(this.e_SpaceDataSet87.Astronomer);
            // TODO: This line of code loads data into the 'e_SpaceDataSet86.Astronomer' table. You can move, or remove it, as needed.
            this.astronomerTableAdapter3.Fill(this.e_SpaceDataSet86.Astronomer);
            // TODO: This line of code loads data into the 'e_SpaceDataSet85.Astronomer' table. You can move, or remove it, as needed.
            this.astronomerTableAdapter2.Fill(this.e_SpaceDataSet85.Astronomer);
            // TODO: This line of code loads data into the 'e_SpaceDataSet84.Astronomer' table. You can move, or remove it, as needed.
            this.astronomerTableAdapter1.Fill(this.e_SpaceDataSet84.Astronomer);
            // TODO: This line of code loads data into the 'e_SpaceDataSet83.Astronomer' table. You can move, or remove it, as needed.
            this.astronomerTableAdapter.Fill(this.e_SpaceDataSet83.Astronomer);
            // TODO: This line of code loads data into the 'e_SpaceDataSet82.E_Jet' table. You can move, or remove it, as needed.
            this.e_JetTableAdapter.Fill(this.e_SpaceDataSet82.E_Jet);
            // TODO: This line of code loads data into the 'e_SpaceDataSet81.E_Jet' table. You can move, or remove it, as needed.
            //this.e_JetTableAdapter2.Fill(this.e_SpaceDataSet81.E_Jet);
            // TODO: This line of code loads data into the 'e_SpaceDataSet62.E_Jet' table. You can move, or remove it, as needed.
            //this.e_JetTableAdapter1.Fill(this.e_SpaceDataSet62.E_Jet);
        ...
        {
            if (textBox1.Text == "" || textBox9.Text == "" || textBox2.Text == "" || textBox5.Text == "" || textBox7.Text == "" || textBox3.Text == "" || guna2ComboBox1.Text == "")
            {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("INSERT INTO Astronomer (Astronomer_ID, Frist_Name, Middle_Name, Last_Name, Designation, Number_of_Space_Hours, Jet_ID) VALUES(' " + textBox1.Text + " ' , ' " + textBox2.Text + " ' ,  ' " + textBox9.Text + " ' , ' " + textBox3.Text + " ' , ' " + textBox5.Text + " ', ' " + textBox7.Text + " ', ' " + guna2ComboBox1.Text + " ' ) ", con);
                cmd.ExecuteNonQuery();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("UPDATE Astronomer SET  Frist_Name='" + textBox2.Text + "', Middle_Name='" + textBox9.Text + "', Last_Name='" + textBox3.Text + "', Designation='" + textBox5.Text + "', Number_of_Space_Hours='" + textBox7.Text + "', Jet_ID='" + guna2ComboBox1.Text + "' WHERE Astronomer_ID='" + textBox1.Text + "' ", con);
                cmd.ExecuteNonQuery();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("DELETE fROM Astronomer where Astronomer_ID like '" + textBox4.Text + "'", con);
                con.Open();
                cmd.ExecuteNonQuery();
        ...
        {
            if (guna2ComboBox2.Text == "" || guna2ComboBox3.Text == "" || guna2ComboBox4.Text == "" || guna2ComboBox5.Text == "" || textBox10.Text == "")
            {
                MessageBox.Show("Fillout the Empty Fields", "Notification", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            else
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("INSERT INTO Pilot (Astronomer_ID, Frist_Name, Middle_Name, Last_Name, Number_of_Space_Hours ) VALUES(' " + guna2ComboBox2.Text + " ' , ' " + guna2ComboBox3.Text + " ' ,  ' " + guna2ComboBox4.Text + " ' , ' " + guna2ComboBox5.Text + " ' , ' " + textBox10.Text + " ') ", con);
                cmd.ExecuteNonQuery();
                MessageBox.Show("Saved Success", "Notification", MessageBoxButtons.OK, MessageBoxIcon.Information);
                clearMethod2();
                gridviewupdate();
        ...
        private void button10_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("UPDATE Pilot SET  Frist_Name='" + guna2ComboBox3.Text + "', Middle_Name='" + guna2ComboBox4.Text + "', Last_Name='" + guna2ComboBox5.Text + "', Number_of_Space_Hours='" + textBox10.Text + "' WHERE Astronomer_ID='" + guna2ComboBox2.Text + "' ", con);
                cmd.ExecuteNonQuery();
                MessageBox.Show("Update Success", "Notification", MessageBoxButtons.OK, MessageBoxIcon.Information);
                clearMethod2();
                gridviewupdate();
        ...
        private void button9_Click(object sender, EventArgs e)
        {
            if (DialogResult.Yes == MessageBox.Show("Do You Want Delete ?", "Confirmation", MessageBoxButtons.YesNo, MessageBoxIcon.Warning))
            {
                SqlCommand cmd = new SqlCommand("DELETE fROM Pilot where Astronomer_ID like '" + textBox8.Text + "'", con);
                con.Open();
                cmd.ExecuteNonQuery();
                MessageBox.Show("Existing Client Details Deleted Successfull", "Client Details Deleted", MessageBoxButtons.OKCancel, MessageBoxIcon.Information);
                clearMethod2();
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            while (sdr.Read())
            {
                guna2ComboBox2.Text = sdr["Astronomer_ID"].ToString();
                guna2ComboBox3.Text = sdr["Frist_Name"].ToString();
                guna2ComboBox4.Text = sdr["Middle_Name"].ToString();
                guna2ComboBox5.Text = sdr["Last_Name"].ToString();
