...
namespace E_space
{
    public partial class Form24 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("INSERT INTO Colonist_Job (Mars_Colonization_ID, Job_ID) VALUES(' " + guna2ComboBox1.Text + " ' , ' " + textBox2.Text + " ' ) ", con);
                cmd.ExecuteNonQuery();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("UPDATE Colonist_Job SET  Mars_Colonization_ID='" + guna2ComboBox1.Text + "' WHERE Job_ID='" + textBox2.Text + "' ", con);
                cmd.ExecuteNonQuery();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("DELETE fROM Colonist_Job where Job_ID like '" + textBox4.Text + "'", con);
                con.Open();
                cmd.ExecuteNonQuery();
        ...
        {
            // TODO: This line of code loads data into the 'e_SpaceDataSet95.Colonist_Job' table. You can move, or remove it, as needed.
            this.colonist_JobTableAdapter.Fill(this.e_SpaceDataSet95.Colonist_Job);
            // TODO: This line of code loads data into the 'e_SpaceDataSet94.Colonist' table. You can move, or remove it, as needed.
            this.colonistTableAdapter.Fill(this.e_SpaceDataSet94.Colonist);
