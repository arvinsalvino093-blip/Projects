...
namespace E_space
{
    public partial class Form8 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("UPDATE E_Jet SET  Made_Year='" + textBox3.Text + "', Weight='" + textBox9.Text + "', Engine_type='" + comboBox2.Text + "', Power_Source='" + comboBox1.Text + "', Number_Of_Passenger_Seats='" + textBox6.Text + "' WHERE Jet_ID='" + textBox1.Text + "' ", con);
                con.Open();
                cmd.ExecuteNonQuery();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("DELETE fROM E_Jet where Jet_ID = '" + textBox4.Text + "'", con);
                con.Open();
                cmd.ExecuteNonQuery();
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("select * from E_Jet where Jet_ID= '" + textBox4.Text + "'", con);
            con.Open();
