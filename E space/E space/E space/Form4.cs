...
namespace E_space
{
    public partial class Form4 : Form
    {
        ...
        {
            if (comboBox1.Text == "" || textBox2.Text == "" || dateTimePicker1.Text == "" || textBox3.Text == "" ||  comboBox1.Text == "" )
            {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("INSERT INTO Dependent (Mars_Colonization_ID, Frist_Name, Last_Name, Gender, DOB, Relationship_To_The_Colonist) VALUES(' " + comboBox1.Text + " ' , ' " + textBox2.Text + " ' ,  ' " + dateTimePicker1.Text + " ' , ' " + textBox3.Text + " ' , ' " + textBox5.Text + " ', ' " + comboBox1.Text + " ') ", con);
                cmd.ExecuteNonQuery();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("UPDATE Dependent SET  Mars_Colonization_ID='" + comboBox1.Text + "', Frist_Name='" + textBox2.Text + "', Last_Name='" + textBox5.Text + "', Gender='" + comboBox1.Text + "', DOB='" + dateTimePicker1.Text + "', Relationship_To_The_Colonist='" + textBox3.Text + "' WHERE Mars_Colonization_ID='" + textBox4.Text + "' ", con);
                cmd.ExecuteNonQuery();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("DELETE fROM Dependent where Mars_Colonization_ID like '" + comboBox1.Text + "'", con);
                con.Open();
                cmd.ExecuteNonQuery();
