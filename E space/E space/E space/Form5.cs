...
namespace E_space
{
    public partial class Form5 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("UPDATE House SET  Colony_Lot_No='" + textBox1.Text + "', Number_OF_Rooms='" + textBox2.Text + "', Square_Feet='" + textBox9.Text + "' WHERE Colony_Lot_No='" + textBox4.Text + "' ", con);
                cmd.ExecuteNonQuery();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("DELETE fROM House where Colony_Lot_No like '" + textBox1.Text + "'", con);
                con.Open();
                cmd.ExecuteNonQuery();
