...
namespace E_space
{
    public partial class Form7 : Form
    {
        ...
        {
            if (textBox1.Text == "" || textBox2.Text == "" || dateTimePicker1.Text == "" || dateTimePicker2.Text == "")
            {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("INSERT INTO Trip (Trip_ID, Launch_Date, Return_Date, Jet_ID) VALUES(' " + textBox1.Text + " ' , ' " + textBox2.Text + " ' , ' " + dateTimePicker1.Text + " ', ' " + dateTimePicker2.Text + " ' ) ", con);
                cmd.ExecuteNonQuery();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("UPDATE Trip SET  Trip_ID='" + textBox1.Text + "', Launch_Date='" + dateTimePicker1.Text + "', Return_Date='" + dateTimePicker2.Text + "', Jet_ID='" + textBox2.Text + "' WHERE Trip_ID='" + textBox4.Text + "' ", con);
                cmd.ExecuteNonQuery();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("DELETE fROM Trip where Trip_ID like '" + textBox1.Text + "'", con);
                con.Open();
                cmd.ExecuteNonQuery();
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            if (sdr.Read())
            {
                ...
                textBox2.Text = sdr["Jet_ID"].ToString();
